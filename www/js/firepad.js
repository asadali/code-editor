...
firepad.AnybaseAdapter = (function (global) {
  ...
  function AnybaseAdapter (ref, userId, userColor) {
    console.log("[AnybaseAdapter] initiated with ", ref, userId, userColor);
    this.ref_ = ref;
    this.ready_ = false;
  ...
  AnybaseAdapter.prototype.dispose = function() {
  ...
  AnybaseAdapter.prototype.setUserId = function(userId) {
    if (this.userRef_) {
  ...
  AnybaseAdapter.prototype.sendOperation = function (operation) {
    var self = this;
  ...
  AnybaseAdapter.prototype.sendCursor = function (obj) {
    this.userRef_.child('cursor').set(obj);
    this.cursor_ = obj;
  };

  AnybaseAdapter.prototype.setColor = function(color) {
    this.userRef_.child('color').set(color);
    this.color_ = color;
  };

  AnybaseAdapter.prototype.getDocument = function() {
    return this.document_;
  };

  AnybaseAdapter.prototype.registerCallbacks = function(callbacks) {
    for (var eventType in callbacks) {
      this.on(eventType, callbacks[eventType]);
    }
  };

  AnybaseAdapter.prototype.initializeUserData_ = function() {
  ...
  AnybaseAdapter.prototype.monitorCursors_ = function() {
  ...
  AnybaseAdapter.prototype.monitorHistory_ = function() {
    var self = this;
  ...
  AnybaseAdapter.prototype.monitorHistoryStartingAt_ = function(revision) {
  ...
  AnybaseAdapter.prototype.handleInitialRevisions_ = function() {
  ...
  AnybaseAdapter.prototype.handlePendingReceivedRevisions_ = function() {
  ...
  AnybaseAdapter.prototype.parseRevision_ = function(data) {
  ...
  AnybaseAdapter.prototype.saveCheckpoint_ = function() {
  ...
  AnybaseAdapter.prototype.firebaseOn_ = function(ref, eventType, callback, context) {
    this.firebaseCallbacks_.push({ref: ref, eventType: eventType, callback: callback, context: context });
    ref.on(eventType, callback, context);
    return callback;
  };

  AnybaseAdapter.prototype.firebaseOff_ = function(ref, eventType, callback, context) {
  ...
  AnybaseAdapter.prototype.removeFirebaseCallbacks_ = function() {
    for(var i = 0; i < this.firebaseCallbacks_.length; i++) {
      var l = this.firebaseCallbacks_[i];
...
firepad.Firepad = (function(global) {
  ...
  var FirebaseAdapter = firepad.AnybaseAdapter;
