...
var _ code.Storage = new(Storage)
...
func (self *Storage) Set(kv *code.KeyValue, succ *bool) error {
	self.strLock.Lock()
	defer self.strLock.Unlock()
...
func (self *Storage) Keys(p *code.Pattern, r *code.List) error {
	self.strLock.Lock()
	defer self.strLock.Unlock()
...
func (self *Storage) ListKeys(p *code.Pattern, r *code.List) error {
	self.listLock.Lock()
...
func (self *Storage) ListGet(key string, ret *code.List) error {
	self.listLock.Lock()
	defer self.listLock.Unlock()
...
func (self *Storage) ListAppend(kv *code.KeyValue, succ *bool) error {
	self.listLock.Lock()
	defer self.listLock.Unlock()
...
func (self *Storage) ListRemove(kv *code.KeyValue, n *int) error {
	self.listLock.Lock()
	defer self.listLock.Unlock()
